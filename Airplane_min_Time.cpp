...
#define  NRD_CL_E  4 /* Number of constraints at the end point */
#define  NRDE_CL_E 2  /* Number of equality constraints at the end point */

//Cruise
#define  NRD_CR_E  4  /* Number of constraints at the end point */
#define  NRDE_CR_E 2  /* Number of equality constraints at the end point */
...
std::string result_file="RES/Result_min_Time.csv";
std::string param_file="RES/Parameters_min_Time.csv";
// Objective Function Weights 

const double q_CL_d = 0.1;

const double q_CR_d = 0.1;

const double q_DE_d = 0.1;

const double q_DE_t = 1.0;
...
static void mfcn_descent_end_time(double *ts, double *xd, double *xa, double *p, double *pr,
  ...
  if (*dpnd) {
      *dpnd = MFCN_DPND(0, 0, 0, *p, 0);   //*ts, *sd, *sa, *u, *p, *pr
      return;
  }
